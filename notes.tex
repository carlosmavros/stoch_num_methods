...
\documentclass[12pt,a4paper]{article}
                ...
                \newtheorem{apodeiksi}[proof]{Απόδειξη}
...
\hypersetup{
 pdfauthor={Κάρλος Μαύρος - ΣΕΜΦΕ ΕΜΠ},
 pdftitle={Στοχαστικές Αριθμητικές Μέθοδοι και Εφαρμογές},
 pdfkeywords={},
 pdfsubject={},
...
\newpage
\section{Μάθημα 1}
\label{sec:org4ac8954}

\subsection{Εισαγωγή}
\label{sec:orgb880a47}
...
\section{Μάθημα 2}
\label{sec:org022bdbb}

\subsection{Στοιχεία Θεωρίας Πιθανοτήτων}
\label{sec:org143a8c4}
...
\textbf{Ιδιότητα} (πηγάζει από την 3) Έστω \(A_1 \supset A_2 \supset \dots\) (contracting sequence of events), τότε ισχύει ότι:
...
\subsection{Το ολοκλήρωμα Lebesgue}
\label{sec:org3e39f33}
